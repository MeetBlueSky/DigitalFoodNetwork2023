			...
			columnDefs: [
				{
					...
					render: function (data, type, full, meta) {
						return   '\<a onclick = "productBaseDuzenle(\'' + data + '\')" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
								<i class="la la-edit"></i>\
							</a>\
							<a onclick = "productBaseSil(\'' + data + '\')" class="btn btn-sm btn-clean btn-icon" title="Delete">\
...
var secilendeger;
function productBaseDuzenle(pid) {
	update = true;
	$('#exampleModalSizeLg').modal('show');
...
function productBaseKaydet() {
	...
	$.ajax({
		...
		cache: false,
		type: "POST",
		url: '/' + lngg + '/Product/CreatedProductBase',
	...
	swal.fire({
		...
		if (data.isConfirmed) {
			...
			$.ajax({
				...
				cache: false,
				type: "POST",
				url: '/' + lngg + '/Product/DeleteProductBase',
				success: function (data) {
