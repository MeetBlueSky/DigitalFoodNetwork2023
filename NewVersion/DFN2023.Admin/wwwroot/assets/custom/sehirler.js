			...
			columnDefs: [
				{
					...
					render: function (data, type, full, meta) {
						 return '\<a onclick = "updateKayit(\'' + data + '\')" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
							...
							<a onclick = "sehirSil(\'' + data + '\')" class="btn btn-sm btn-clean btn-icon" title="Delete">\
...
function updateKayit(pid) {
	...
	$("#Country").val(secilenDeger.CountryId).trigger('change');
...
function sehirEkleGuncelle(pid) {
