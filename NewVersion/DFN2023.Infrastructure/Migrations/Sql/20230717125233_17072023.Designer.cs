...
namespace DFN2023.Infrastructure.Migrations.Sql
{
    ...
    [Migration("20230717125233_17072023")]
    partial class _17072023
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DFN2023.Entities.EF.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DFN2023.Entities.EF.MenuManagement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MenuFeatureId")
                        .HasColumnType("int");

                    b.Property<int>("MenuLayer")
                        .HasColumnType("int");

                    b.Property<string>("MenuLayerCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DFN2023.Entities.EF.SliderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DFN2023.Entities.EF.Message", b =>
                {
                    ...
                    b.HasOne("DFN2023.Entities.EF.User", "UserT")
                        .WithMany("MessageT")
            ...
            modelBuilder.Entity("DFN2023.Entities.EF.Slider", b =>
                {
                    b.HasOne("DFN2023.Entities.EF.SliderHeader", "SliderHeader")
                        .WithMany("Slider")
                        .HasForeignKey("Type")
                        .IsRequired()
                        .HasConstraintName("FK_Slider_SliderHeader");

                    b.Navigation("SliderHeader");
                });
